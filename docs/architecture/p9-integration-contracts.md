...
**Baseline inspected:** P8 cinema compiler, schema migration 12 (`0012_cinema_compiler.sql`).
...
**12** is the current latest. Do not edit a shipped migration. The ordered P0–P8
...
- Add migrations only after version 12 and register them in `MIGRATIONS`.
