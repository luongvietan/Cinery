...
export function createScene(
  ...
  return invokeCommand<Scene>("create_scene", {
    projectRootPath,
    title,
    summary,
  });
...
export function listScenes(projectRootPath: string): Promise<Scene[]> {
  return invokeCommand<Scene[]>("list_scenes", { projectRootPath });
}
...
export function getScene(
  ...
  return invokeCommand<Scene>("get_scene", { projectRootPath, sceneId });
}
...
export function addSceneCharacter(
  ...
  return invokeCommand<SceneCharacterAssignment>("add_scene_character", {
    projectRootPath,
    sceneId,
    characterEntityId,
    lookAssetVersionId,
...
export function removeSceneCharacter(
  ...
  return invokeCommand<void>("remove_scene_character", {
    projectRootPath,
    sceneId,
    characterEntityId,
  });
...
export function addSceneProp(
  ...
  return invokeCommand<ScenePropAssignment>("add_scene_prop", {
    projectRootPath,
    sceneId,
    propAssetVersionId,
    label: label ?? null,
...
export function removeSceneProp(
  ...
  return invokeCommand<void>("remove_scene_prop", {
    projectRootPath,
    sceneId,
    propAssetVersionId,
  });
