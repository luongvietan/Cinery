...
type PanelView = "none" | "assets" | "workflows" | "production" | "canon" | "worlds" | "scenes" | "providers";
  ...
  return (
    <>
      ...
      <nav>
        ...
        <button
          type="button"
          aria-pressed={panelView === "worlds"}
          className={panelView === "worlds" ? "nav-button nav-button--active" : "nav-button"}
          onClick={() => {
            setPanelView("worlds");
            setSelectedAssetId(null);
          }}
        ...
        <button
          type="button"
          aria-pressed={panelView === "scenes"}
          className={panelView === "scenes" ? "nav-button nav-button--active" : "nav-button"}
          onClick={() => {
            setPanelView("scenes");
            setSelectedAssetId(null);
          }}
