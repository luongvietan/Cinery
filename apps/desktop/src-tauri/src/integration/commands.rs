...
) -> Result<Vec<crate::integration::health::ProjectHealthIssue>, AppCommandError> {
    validate_root_path(&project_root_path)?;
    crate::integration::health::scan_project(Path::new(&project_root_path))
...
pub fn get_provenance_graph(
    ...
    target_kind: String,
    target_id: String,
) -> Result<crate::integration::provenance::ProvenanceGraph, AppCommandError> {
    validate_root_path(&project_root_path)?;
    crate::integration::provenance::get_provenance_graph(
