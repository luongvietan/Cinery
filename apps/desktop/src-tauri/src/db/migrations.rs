...
pub const MIGRATIONS: &[Migration] = &[
    ...
    Migration::new(
        3,
        include_str!("../../migrations/0003_asset_version_dimensions.sql"),
    ),
    Migration::new(4, include_str!("../../migrations/0004_canon_engine.sql")),
    Migration::new(
        5,
        include_str!("../../migrations/0005_workflow_runtime.sql"),
    ),
    Migration::new(
        6,
        include_str!("../../migrations/0006_provider_integrations.sql"),
    ),
    Migration::new(
        7,
        include_str!("../../migrations/0007_provider_audit_events.sql"),
    ),
    Migration::new(
        8,
        include_str!("../../migrations/0008_generated_artifacts.sql"),
    ),
    Migration::new(
        9,
        include_str!("../../migrations/0009_artifact_lineage.sql"),
    ),
    Migration::new(10, include_str!("../../migrations/0010_visual_qa.sql")),
    Migration::new(
        11,
        include_str!("../../migrations/0011_visual_qa_repairs.sql"),
    ),
    Migration::new(
        12,
        include_str!("../../migrations/0012_cinema_compiler.sql"),
    ),
    Migration::new(
        13,
        include_str!("../../migrations/0013_performance_indexes.sql"),
    ),
    Migration::new(
        14,
    ...
    Migration::new(
        15,
        include_str!("../../migrations/0015_custom_provider_purpose.sql"),
    ),
    Migration::new(
        16,
        include_str!("../../migrations/0016_world_scene_pipeline.sql"),
    ),
    Migration::new(
        17,
        include_str!("../../migrations/0017_unified_scene_shots.sql"),
    ),
    Migration::new(
        18,
    ...
    Migration::foreign_key_rebuild(21, include_str!("../../migrations/0021_shot_video_pin.sql")),
    Migration::new(
        22,
...
fn migration_0022_adds_durable_background_job_bookkeeping() {
    ...
    .unwrap();
    let (progress, last_polled, operation): (Option<i64>, Option<String>, Option<String>) = conn
        .query_row(
