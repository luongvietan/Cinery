...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            cinema::commands::rename_scene,
            cinema::commands::set_scene_world,
            cinema::commands::update_scene_character,
            cinema::commands::remove_scene_character,
            cinema::commands::remove_scene_prop,
