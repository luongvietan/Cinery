...
#[tauri::command]
pub fn list_world_scenes(project_root_path: String) -> Result<Vec<Scene>, AppCommandError> {
    project_service::validate_root_path(&project_root_path)?;
    let root = PathBuf::from(project_root_path);
...
#[tauri::command]
pub fn add_world_scene_character(
    project_root_path: String,
    scene_id: String,
...
#[tauri::command]
pub fn remove_world_scene_character(
    project_root_path: String,
    scene_id: String,
    character_entity_id: String,
...
#[tauri::command]
pub fn remove_world_scene_prop(
    project_root_path: String,
    scene_id: String,
    prop_asset_version_id: String,
) -> Result<(), AppCommandError> {
...
#[tauri::command]
pub fn get_world_scene_readiness(
    project_root_path: String,
    scene_id: String,
